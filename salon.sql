...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-11-2023 a las 19:00:55
...
--
ALTER TABLE `citas_servicios`
  ADD CONSTRAINT `citas_servicios_ibfk_1` FOREIGN KEY (`citaId`) REFERENCES `citas` (`id`),
  ADD CONSTRAINT `citas_servicios_ibfk_2` FOREIGN KEY (`serviciosId`) REFERENCES `servicios` (`id`);
COMMIT;
